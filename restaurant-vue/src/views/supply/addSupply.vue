        ...
        <div>
          ...
          >
            <el-input v-model="ruleForm.email"
                      placeholder="请填写联系人邮件"
            />
          </el-form-item>
        </div>
        <div>
          <el-form-item label="供货商地址信息:"
                        prop="address"
          >
            <el-input v-model="ruleForm.address"
                      placeholder="请填写供货商地址"
            />
          </el-form-item>
        </div>
        <!--        <div>-->
...
import AddDish from './components/AddSupply.vue'
import { getCategoryList } from '@/api/dish'
import { addTable, editTable, queryTableById } from '../../api/table'
import { addSupply, editSupply, querySupplyById } from '../../api/supply'
...
export default class extends Vue {
  ...
  private async init() {
    querySupplyById(this.$route.query.id).then(res => {
