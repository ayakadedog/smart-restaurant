...
<!--      上面搜索名称-->
      <div class="tableBar">
        <label style="margin-right: 10px">供应商名字：</label>
        <el-input v-model="supplierName"
                  placeholder="请填写供应商名字"
                  style="width: 14%"
                  clearable
                  @clear="init"
                  @keyup.enter.native="initFun" />
        <label style="margin-right: 10px; margin-left: 20px">联系人姓名：</label>
        <el-input v-model="contactName"
                  ...
                  @clear="init"
                  @keyup.enter.native="initFun" />
        <label style="margin-right: 10px; margin-left: 20px">联系人电话：</label>
        <el-input v-model="contactPhone"
                  ...
                  @clear="init"
                  @keyup.enter.native="initFun" />
<!--        <label style="margin-right: 10px; margin-left: 20px">联系人邮件：</label>-->
...
import { deleteSupplyById, getSupplyPage } from '../../api/supply'
...
export default class extends Vue {
  ...
  private async init(isSearch?) {
    ...
    await getSupplyPage({
      ...
      contractPhone: this.contactPhone || undefined,
  ...
  // 添加更改
  private addSupply(st: any) {
    if (st === 'add') {
      this.$router.push({ path: '/supply/add' })
    } else {
      this.$router.push({ path: '/supply/add', query: { id: st.id } })
    }
  }
