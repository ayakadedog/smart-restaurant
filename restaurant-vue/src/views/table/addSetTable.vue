      ...
      >
        <div>
          <el-form-item label="桌号:"
                        prop="套餐名称"
          >
            <el-input v-model="ruleForm.tableNumber"
                      placeholder="请填写桌号"
                      maxlength="14"
            />
          </el-form-item>
          <el-form-item label="餐桌容纳人数:"
                        prop="seatNumber"
          >
        ...
        <div>
          <el-form-item label="餐桌类型:"
                        prop="tableType"
          >
            <el-input v-model="ruleForm.tableType"
                      placeholder="请填写餐桌类型"
            />
          </el-form-item>
        </div>
...
import AddDish from './components/AddTable.vue'
import { getCategoryList } from '@/api/dish'
import { addTable, editTable, queryTableById } from '../../api/table'
...
export default class extends Vue {
  ...
  private async init() {
    queryTableById(this.$route.query.id).then(res => {
