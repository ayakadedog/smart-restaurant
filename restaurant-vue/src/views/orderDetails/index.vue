  ...
  <div class="dashboard-container">
    ...
    <div class="container" :class="{ hContainer: tableData.length }">
      ...
      <div class="tableBar">
        ...
        />
        <label style="margin-left: 20px">桌号：</label>
        <el-input
          v-model="tableNumber"
          placeholder="请填写桌号"
          style="width: 15%"
      ...
      >
        ...
        />
        <el-table-column
          v-if="[0,2,3,4,6].includes(orderStatus)"
          key="orderTime"
          prop="orderTime"
          label="下单时间"
        ...
        <div class="order-bottom">
          <div class="amount-info">
            ...
            <div class="amount-list">
              ...
              <!--                >-->
              <!--              </div>-->
              <div class="all-amount" style="padding-left: 0px;margin-bottom: 20px">
      ...
      <el-form label-width="90px">
        ...
        <el-form-item v-if="cancelReason === '自定义原因'" label="原因：">
          <el-input
            v-model.trim="remark"
            type="textarea"
            :placeholder="'请填写您' + cancelDialogTitle + '的原因'"
          />
        </el-form-item>
      </el-form>
