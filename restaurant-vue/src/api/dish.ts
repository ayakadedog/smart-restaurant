...
// 查询列表接口
export const getDishPage1 = (params: any) => {
  return request({
    url: '/dish/page/use',
    method: 'get',
    params
...
// 查询列表接口
export const getDishPageNoUse = (params: any) => {
  return request({
    url: '/dish/page/noUse',
    method: 'get',
    params
...
export const getMustDishPage = (params: any) => {
  return request({
    url: '/dish/must',
    method: 'get',
    params
...
// 查询列表接口
export const getChartPage = (params: any) => {
  return request({
    url: '/chart/page',
    method: 'get',
    params
...
// 删除接口
export const deleteChart = (ids: string) => {
  return request({
    url: '/chart',
    method: 'delete',
    params: { ids }
...
export const addChart = (params: any) => {
  return request({
    url: '/chart/add',
    method: 'post',
    data: { ...params }
